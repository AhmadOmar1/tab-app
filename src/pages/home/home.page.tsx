...
const Home = () => {
  ...
  return <Fade in={isLoaded} timeout={3000}>
    <Paper
      elevation={0}
    ...
    >
      ...
      <Container maxWidth="lg" sx={{
        ...
        <Box sx={{
          ...
          <Typography variant="h3" component="div" color={theme.palette.primary.light} gutterBottom textAlign='center' className={styles.homeTitle}>
            Travel and Accommodation Booking Platform
          </Typography>

          <Typography variant="h6" component="div" gutterBottom textAlign='center' className={styles.homeSecondTitle}>
        ...
        <Box my={10} >
          <Box>
            <Typography variant="h4" color={theme.palette.secondary.dark} component="span" textAlign='start' gutterBottom className={styles.homeHeader}  >
              Feature {''}
            </Typography>
            <Typography variant="h4" color={theme.palette.secondary.light} component="span" textAlign='start' gutterBottom className={styles.homeHeader}  >
              Deals
            </Typography>
            <Typography variant="h6" color={theme.palette.secondary.light} component="div" textAlign='start' gutterBottom className={styles.secondHomeHeader}  >
