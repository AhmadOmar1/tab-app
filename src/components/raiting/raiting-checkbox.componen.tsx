...
export const RatingCheckbox: React.FC<RatingCheckboxProps> = ({ value , setValue }) => {
  ...
  return (
    <FormControl sx={{ pl: 2 }}>
      ...
      >
        <FormControlLabel value="5" control={<BpRadio />}
          label={
            <Rating readOnly value={5} />
          } />
        <FormControlLabel value="4" control={<BpRadio />}
          label={
